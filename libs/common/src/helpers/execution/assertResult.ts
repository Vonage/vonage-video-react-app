...
import { isPromise } from '@common/helpers/data/promises';
import { isFunction } from '@common/helpers/data/functions';
import isApplicationError from '@common/helpers/errors/isApplicationError';
import type { ApplicationErrorFallbackConfig } from '@common/helpers/errors/ApplicationError.types';
...
type BuilderSource =
  | ErrorProps
  | ((error: any) => ApplicationError | ErrorProps);
