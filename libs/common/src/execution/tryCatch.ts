import isPromise from '../data/promises';
...
> = T extends () => Promise<infer R>
  ...
  : {
      result: Fallback extends undefined
        ? ReturnType<T> | null
...
function tryCatch<
  T extends () => any,
  Fallback extends Awaited<ReturnType<T>> | undefined
>(callback: T, fallback?: Fallback): TryCatchResult<T, Fallback> {
  try {
