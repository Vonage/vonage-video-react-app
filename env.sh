...
# DEV Okta tenant (SPA/public client — issuer URL and client ID are non-secret). Override via
# backend/.env for PROD, which has its own issuer and client ID (see docs/CONFIGURATION.md).
