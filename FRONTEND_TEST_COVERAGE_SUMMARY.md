...
**Total Analytics:** 34 Hooks + 6 APIs analyzed  
...
| 5 | **useSessionContext** | Hook | `frontend/src/hooks/useSessionContext.tsx` | 2 | Direct | NO |
| 6 | **useSubscribersInDisplayOrder** | Hook | `frontend/src/hooks/useSubscribersInDisplayOrder.tsx` | 2 | Direct | NO |
| 7 | **useWaitingRoom** | Hook | `frontend/src/hooks/useWaitingRoom.ts` | 2 | Direct | NO |
| 8 | **useActiveSpeaker** | Hook | `frontend/src/hooks/useActiveSpeaker.tsx` | 1 | Indirect | NO |
| 9 | **useAudioLevels** | Hook | `frontend/src/hooks/useAudioLevels.tsx` | 1 | Indirect | NO |
| 10 | **useChat** | Hook | `frontend/src/hooks/useChat.tsx` | 1 | Indirect | NO |
...
| 3 | **useDecodedSessionKey** (CRITICAL) | Hook | `frontend/src/hooks/useDecodedSessionKey.ts` | 0 | High | YES |
| 4 | **useDropdownResizeObserver** (CRITICAL) | Hook | `frontend/src/hooks/useDropdownResizeObserver.tsx` | 0 | High | YES |
| 5 | **useElementDimensions** (CRITICAL) | Hook | `frontend/src/hooks/useElementDimensions.tsx` | 0 | High | YES |
| 6 | **useEmoji** (CRITICAL) | Hook | `frontend/src/hooks/useEmoji.tsx` | 0 | High | YES |
| 7 | **useIsSmallViewport** (CRITICAL) | Hook | `frontend/src/hooks/useIsSmallViewport.tsx` | 0 | High | YES |
| 8 | **useIsTabletViewport** (CRITICAL) | Hook | `frontend/src/hooks/useIsTabletViewport.tsx` | 0 | High | YES |
| 9 | **usePreferredCameras** (CRITICAL) | Hook | `frontend/src/hooks/usePreferredCameras/usePreferredCameras.ts` | 0 | High | YES |
| 10 | **usePushToTalk** (CRITICAL) | Hook | `frontend/src/hooks/usePushToTalk.tsx` | 0 | High | YES |
...
| **getArchives** (CRITICAL) | API | `frontend/src/api/archiving/getArchives/getArchives.ts` | 0 | None | High | YES |
| **index** (CRITICAL) | API | `frontend/src/api/archiving/getArchives/index.ts` | 0 | None | High | YES |
...
| **useDecodedSessionKey** (CRITICAL) | Hook | `frontend/src/hooks/useDecodedSessionKey.ts` | 0 | None | High | YES |
...
| **useSessionKeyParam** (CRITICAL) | Hook | `frontend/src/hooks/useSessionKeyParam.ts` | 0 | None | High | YES |
...
## Summary Statistics
- Total frontend functions tracked: 40
- Tested (mapped by 2+ suites): 7
- Partial (mapped by 1 suite): 11
- Untested (0%): 22 functions
...
- [CRITICAL] Untested (0%): 22 functions need at least one mapped e2e path.

---

## Risk Assessment
- High risk functions: 22
- Medium risk functions: 11
- Low risk functions: 7
