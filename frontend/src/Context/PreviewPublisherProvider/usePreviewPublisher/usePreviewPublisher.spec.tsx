...
describe('usePreviewPublisher', () => {
  ...
  describe('initLocalPublisher', () => {
    it('should call initLocalPublisher', async () => {
      ...
      await result.current.initializeLocalPublisher();
  ...
  describe('changeBackground', () => {
    ...
    beforeEach(async () => {
      ...
      await act(async () => {
        await (result.current as ReturnType<typeof usePreviewPublisher>).initializeLocalPublisher();
      });
    ...
    it('logs an error if applyBackgroundFilter rejects', async () => {
      ...
      await act(async () => {
        await res.current.initializeLocalPublisher();
