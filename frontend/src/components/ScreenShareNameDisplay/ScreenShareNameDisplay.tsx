...
const ScreenShareNameDisplay = ({ name, box }: ScreenShareNameDisplayProps): ReactElement => {
  ...
  return (
    <div
      className="absolute bottom-0 left-1.5 overflow-hidden whitespace-nowrap rounded-vera-medium bg-vera-dark-grey-opacity px-2 py-1 text-ellipsis text-vera-accent"
      style={{
